...
const MUTATIONS = [
  {
    ...
    expect: ['B3.label-both-languages-off', 'B3b.muted-state-attributes', 'B4.icon-two-states', 'C2.unmute-clears-override', 'C2c.local-table-back-to-follow', 'C6.mute-one-session-only', 'C6b.only-the-other-session-rings', 'C6c.suppressedSession-one', 'E7.muted-session-does-not-sound', 'E8.gap-survives-mute', 'E9.suppressedSession-counted', 'E9b.batch-counters-after-mute', 'I1b.one-POST-per-click'],
  },
  {
