...
const implementationTokens = [
  ...
  ['C.2', 'it registers under the settings.plugin.item slot', CLIENT_SOURCE, /var SLOT = 'settings\.plugin\.item'|ctx\.slots\.inject\(SLOT/],
  ['C.2b', 'the card key is the settings namespace', CLIENT_SOURCE, /key: NS, locale: NS/],
